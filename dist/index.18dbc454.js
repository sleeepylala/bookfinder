...
${frame.code}`;
      ...
      function (require, module, exports) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
          ...
          const isValidCategory = (input) =>
            (0, _lodashDefault.default).includes(
              validCategories,
              input.toLowerCase()
            );
          const getCategory = async () => {
            ...
            try {
              ...
              const response = await (0, _axiosDefault.default).get(
    ...
    fCgem: [
      ...
      { "9c62938f1dccc73c": "eIiSV", aceacb6a4531a9d2: "cO95r" },
    ],
    eIiSV: [
      function (require, module, exports) {
        "use strict";
